...
//creating constants
const TString default_run = "Run1477.root"; //this is gel: (0,5)
const float default_cut_min = 30000;
const TString string_default_cut_min = "30000";
const float default_cut_max = 65000;
const TString string_default_cut_max = "65000";
const int nbins = 190;
...
double scaled_area(TString test_df, float scale){
    ...
    pos64->Draw("area_2988_1*"+string_scale+">>pos64Hist(300,0,200000)",
                "area_2988_1>"+cut_scale_min +" && area_2988_1<"+cut_scale_max,
                "histnorm");
    pos05->Draw("area_2988_1>>pos05Hist(300,0,200000)",
                "area_2988_1>"+string_default_cut_min+" && area_2988_1<"+string_default_cut_max+"",
                "histsamenorm");
...
void print_scaled_graphs(TString test_df, float scale){
    ...
    pos64->Draw("area_2988_1*"+string_scale+">>pos64Hist(120,0,200000)",
                "",
                "histnorm");
    pos05->Draw("area_2988_1>>pos05Hist(120,0,200000)",
                "",
                "histsamenorm");
